...
<div class="sidebar">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <a href="#" class={`nav-link text-white ${selecteditem === "Home" && "active"}`} aria-current="page">
      ...
      <li
         onClick={() => {
          setselecteditem("Createpost");}}>
        <a href="#" class={`nav-link text-white ${selecteditem === "Createpost" && "active"}`}>
